...
- CI must be green before merge: `detect changes`, `ci` (the full Linux
  lane in one job), and `build / macos-latest`. PRs touching only Markdown,
  `docs/`, or `LICENSE` skip the Go work.
